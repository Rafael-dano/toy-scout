  ...
  const products = [
    {
      ...
      {
        title: '550pcs Ferrite Putty',
        image: 'https://m.media-amazon.com/images/I/71pl0uaectL._AC_SX679_.jpg',
        description: '550pcs Ferrite Putty, Fidget Toys, Desk Fidgets Toys for Stress/Anxiety Relief.',
        text: "Say hello to your new favorite desk buddy 🖐️✨ This magnetic bead fidget toy is oddly satisfying and endlessly fun! Boost focus and relieve stress. Shape, stretch, and sculpt creative designs. Comes with strong magnets for tactile play. Great for kids AND adults! Perfect for work, study breaks, or just zoning out. Fun meets function in the most magnetic way!",
        price: '$12.59',
        link: 'https://www.amazon.com/dp/B0C9HT866S?ref=t_ac_view_request_product_image&campaignId=amzn1.campaign.36FL81D93Q0W9&linkCode=tr1&tag=more4kids0a-20&linkId=amzn1.campaign.36FL81D93Q0W9_1750376419615&th=1',
      },
  ];
...
return (
  <div className="p-6 max-w-6xl mx-auto">
    <Helmet>
      <title>12 Must-Have Kids’ Toys for Summer 2025 — Outdoor Fun, STEM Learning & More! | My Toy Scout</title>
      <meta
        name="description"
        content="Keep your kids smiling and learning all summer with these 12 top-rated toys of 2025! From splash pads to talking books, STEM telescopes to bubble machines — explore parent-approved picks perfect for Prime Day deals."
      />
       {/* Open Graph / Facebook */}
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://mytoyscout.netlify.app/blog/must-haves" />
      <meta property="og:title" content="12 Must-Have Kids’ Toys for Summer 2025 — Outdoor Fun, STEM Learning & More! | My Toy Scout" />
      <meta property="og:description" content="Keep your kids smiling and learning all summer with these 12 top-rated toys of 2025! From splash pads to talking books, STEM telescopes to bubble machines — explore parent-approved picks perfect for Prime Day deals." />
      <meta property="og:image" content="https://mytoyscout.netlify.app/assets/mascot-toys-DUp45_TC.png" />

      {/* Twitter Card */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:url" content="https://mytoyscout.netlify.app/blog/must-haves" />
      <meta name="twitter:title" content="12 Must-Have Kids’ Toys for Summer 2025 — Outdoor Fun, STEM Learning & More!| My Toy Scout" />
      <meta name="twitter:description" content="Keep your kids smiling and learning all summer with these 12 top-rated toys of 2025! From splash pads to talking books, STEM telescopes to bubble machines — explore parent-approved picks perfect for Prime Day deals." />
      <meta name="twitter:image" content="https://mytoyscout.netlify.app/assets/mascot-toys-DUp45_TC.png" />
         <script type="application/ld+json">
  {JSON.stringify({
    "@context": "https://schema.org",
    "@type": "BlogPosting",
    "headline": "12 Must-Have Kids’ Toys for Summer 2025 — Outdoor Fun, STEM Learning & More!",
    "description": "Keep your kids smiling and learning all summer with these 12 top-rated toys of 2025! From splash pads to talking books, STEM telescopes to bubble machines — explore parent-approved picks perfect for Prime Day deals.",
...
"datePublished": "2025-06-27"
    ...
    <h1 className="text-3xl font-bold mb-6">12 Must-Have Kids’ Toys for Summer 2025</h1>
