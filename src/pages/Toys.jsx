...
const Toys = () => {
  return (
    <div className="toys-page">
      <Helmet>
        <title>Shop Outdoor & Educational Toys | Toy Scout</title>
      ...
      <meta property="og:title" content="Shop Outdoor & Educational Toys | Toy Scout" />
     <meta property="og:description" content="Browse top-rated toys by category: outdoor, educational, STEM, and more. Find fun, safe toys for every age and interest." />
      ...
      <meta name="twitter:title" content="Shop Outdoor & Educational Toys | Toy Scout" />
