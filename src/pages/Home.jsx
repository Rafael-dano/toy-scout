      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-4 border rounded shadow">
            <h3 className="text-xl font-semibold">Best Kids’ Backpacks, Lunch Boxes & Supplies for 2025</h3>
            <p className="text-sm text-gray-500 mb-2">August 13, 2025</p>
            <p className="text-gray-700 mb-2">Start the school year right with the coolest backpacks, lunch kits, and kid-approved supplies that combine function, fun, and style.</p>
            <Link to="/blog/best-kids-school-supplies-2025" className="text-blue-500 hover:underline text-sm">Read More</Link>
          </div>
        </div>
      </section>
