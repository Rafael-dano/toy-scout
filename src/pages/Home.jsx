      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-4 border rounded shadow">
            <h3 className="text-xl font-semibold">STEM Sports Toys That Teach More Than Just the Game</h3>
            <p className="text-sm text-gray-500 mb-2">September 12, 2025</p>
            <p className="text-gray-700 mb-2">Merge learning with athletics using these STEM toys that build skills in math, physics, and teamwork—all through sports.</p>
            <Link to="/blog/stem-sports-toys-that-teach-more-than-just-the-game" className="text-blue-500 hover:underline text-sm">Read More</Link>
          </div>
        </div>
      </section>
