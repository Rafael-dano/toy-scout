      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="p-4 border rounded shadow">
            <h3 className="text-xl font-semibold">Must-Have Toys for Your Kid’s Locker or Backpack</h3>
            <p className="text-sm text-gray-500 mb-2">September 4, 2025</p>
            ...
            <Link to="/blog/toys-for-kids-locker-backpack" className="text-blue-500 hover:underline text-sm">Read More</Link>
          </div>
        </div>
      </section>
